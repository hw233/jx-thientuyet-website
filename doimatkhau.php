...
<title>ĐỔI MẬT KHẨU - VÕ LÂM TRUYỀN KỲ</title>
<script language="javascript">
function check()
{
 var passwordcu = document.getElementById('passwordcu').value;
    var passwordmoi = document.getElementById('passwordmoi').value;
	   if (isEmpty(passwordcu)) {
        status = false;
        errorMessage += "Bạn chưa nhập mật khẩu hiện tại.\n";
    }
...
<div class="WrapperBG">
 ...
 <div class="contentHTML">
  <div class="title">
    <div class="titleLocation"> <font color=blue><b>• NHẬP THÔNG TIN XÁC THỰC ĐỂ TIẾN HÀNH ĐỔI MẬT KHẨU :</b></font></span></div>
  </div>
  ...
  <div class="boxContent">
    ...
    <div class="box_content">
      <form method="post" action="ktdoimatkhau1.php">
        <table width="509" border="0">
		<tr>
            <td width="152"><font color=green><b>+ Tên Tài Khoản :</b></font></td>
            <td width="275"><label>
          ...
          <tr>
            <td width="152"><font color=green><b>+ Mật Khẩu Hiện Tại :</b></font></td>
            <td width="275"><label>
          ...
          <tr>
            <td><font color=green><b>+ Nhập Mật Khẩu Mới :</b></font></td>
            <td><label>
