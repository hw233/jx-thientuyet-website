...
if ($ma<>$_SESSION['ma'])
	{
		echo "<script language=Javascript1.1>alert(\"Bạn đã nhập sai mã bảo vệ. Vui lòng nhập lại...\");</script>";
...
else
{
	...
	if ($num_row==0)
	{
		$sql="INSERT INTO Account_Info(cAccName,cPassWord,cPhone,cEMail,cRealName,dRegDate,cQuestion,cAnswer) VALUES ('$taikhoan','$matkhau','$fone','$email','$ten','10/10/2000 10:10:10 AM','$cauhoi','$traloi');";
		mssql_query($sql,$ketnoi)or die ("Đăng ký thông tin không thành công");
		$sql="INSERT INTO Account_Habitus(cAccName,iFlag,iLeftSecond,nExtPoint,dBeginDate,iLeftMonth,dEndDate) VALUES('$taikhoan','0','999','999','1/1/2010 3:17:04 PM','999','10/10/2012 10:10:10 AM');";
		mssql_query($sql,$ketnoi)or die ("Đăng ký thông tin không thành công");
		mssql_close($ketnoi);
	...
	{
		echo "<script language=Javascript1.1>alert(\"Tài khoản đã có người sử dụng. Vui lòng chọn tên đăng nhập khác...\");</script>";
		echo("<script language='JavaScript'>window.top.location='dangky.php';</script>"); 
