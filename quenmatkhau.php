...
<title>QUÊN MẬT KHẨU - VÕ LÂM TRUYỀN KỲ</title>
...
function check()
{
 var username = document.getElementById('username').value;
    var email = document.getElementById('email').value;
	   if (isEmpty(username)) {
        status = false;
        errorMessage += "Bạn chưa nhập tên tài khoản.\n";
    }
	   if (isEmpty(passwordmoi)) {
        status = false;
        errorMessage += "Bạn chưa nhập email đăng kí.\n";
    }
}
</script>
<style type="text/css">
...
<div class="WrapperBG">
              ...
              <div class="StaticInner">
                ...
                <div class="StaticTopPanel"><img
                  ...
                  <ul id="breadcrumbs">
                    ...
                    <li itemprop="url"><span class="Active" itemprop="title">Quên Mật Khẩu</span></li>
                  </ul>
            </div>
		<!----------------------------------------------- STORY------------------------------------------------>
 ...
 <div class="contentHTML">
  <div class="title">
  <div class="titleLocation"><b>• NHẬP THÔNG TIN TÀI KHOẢN ĐỂ KHÔI PHỤC MẬT KHẨU :</b></div>
  </div>
  ...
  <div class="boxContent">
    ...
    <div class="box_content">
      <form method="post" action="ktquenmatkhau.php">
        <table width="509" border="0">
          <tr>
            <td width="152"><strong><font color=green><b>+ Tên Tài Khoản :</b></font></strong></td>
            <td width="275"><label>
          ...
          <tr>
		   ...
		   <tr>
            ...
            <td><label>
              <input type="text" name="traloi" id="traloi" />       
            </label></td>
            <td>&nbsp;</td>
          </tr>
		  <tr>
            <td width="152"><strong><font color=green><b>+ Nhập Mật Khẩu Mới :</b></font></strong></td>
            <td width="275"><label>
              <input type="password" name="passmoi" id="passmoi" />
            </label></td>
            <td width="70">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><label>
              <input type="submit" name="Submit" value="YES" class="Accept"/>
    ...
    <div class="ColumnRight">
                    <a href="ymsgr:sendIM?hotrovolamtruyenky&amp" rel="ajax"><span style="font-weight:bold"><font color=red>•<ins> LIÊN HỆ HỖ TRỢ NẾU KHÔNG NHỚ THÔNG TIN TÀI KHOẢN «</ins></font></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
		  </div>			  
		  </div>
		  <div class="content-b">
