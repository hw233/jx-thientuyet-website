...
<title>ĐỔI THÔNG TIN - VÕ LÂM TRUYỀN KỲ</title>
...
{
ten.value=trim(ten.value);
fone.value=trim(fone.value);
traloi.value=trim(traloi.value);
...
<div class="WrapperBG">
              ...
              <div class="StaticInner">
                ...
                <div class="StaticTopPanel"><img
                  ...
                  <ul id="breadcrumbs">
                    ...
                    <li itemprop="url"><span class="Active" itemprop="title">Đổi Mật Khẩu</span></li>
                  </ul>
            </div>
 ...
 <div class="contentHTML">
  <div class="title">
    <div class="titleLocation"><b>• NHẬP THÔNG TIN XÁC THỰC ĐỂ TIẾN HÀNH CẬP NHẬT :</b></span></div>
  </div>
  ...
  <form class="formular" method="post" name="form1" action="ktcapnhat.php" onsubmit="return checkform()">
    <p>&nbsp;</p>
    <table width="479" border="0" align="center">
      <tr>
        <td width="123"><font color=green><b> Tài Khoản Thứ :</b></td>
        <td width="346"><font color=red><b>{$member['iid']}</b></td>
      </tr>
      <tr>
        <td><font color=green><b>Ngày Đăng Ký :</b></td>
        <td><font color=red><b>{$member['dRegDate']}</b></td>
      </tr>
      <tr>	  
        <td><font color=green><b>Tên Tài Khoản :</b></td>
        <td><font color=red><b>{$member['cAccName']}</b><input type="hidden" value="{$member['cAccName']}" name="taikhoan"></td>
      </tr>
      <tr>
        <td><font color=green><b>Số Điện Thoại :</b></td>
        <td><input type="text" name="fone" value="{$member['cPhone']}"></td>
      </tr>
      <tr>  
        <td><font color=green><b>Tên Thành Viên :</b></td>
        <td><input type="text" name="ten" value="{$member['cRealName']}"></td>
      </tr>
      <tr>      
        <td><font color=green><b>Email Đăng Ký :</b></td>
        <td><input type="text" name="email" value="{$member['cEMail']}">
          <strong>( D&ugrave;ng &#273;&#7875; l&#7845;y l&#7841;i m&#7853;t kh&#7849;u ) </strong></td>		
      </tr>
      <tr>
        <td><font color=green><b>Câu Hỏi Bí Mật :</b></td>
        <td><input type="text" name="cauhoi" value="{$member['cQuestion']}">   
		   <strong>( D&ugrave;ng &#273;&#7875; l&#7845;y l&#7841;i m&#7853;t kh&#7849;u )</strong> </td>
      </tr>
      <tr>
	    <td><font color=green><b>Câu Trã Lời Bí Mật :</b></td>
        <td><input type="text" name="traloi" value="{$member['cAnswer']}"> 
          <strong>( D&ugrave;ng &#273;&#7875; l&#7845;y l&#7841;i m&#7853;t kh&#7849;u )</strong> </td>
      </tr>
     
      <tr>
        <td>&nbsp;</td>
        <td><input name="Submit" type="submit" onClick="MM_validateForm('ten','','R','fone','','R','traloi','','R','email','','R','txtVerify','','R');return document.MM_returnValue" value="NHẬP"class="Accept"/>
  ...
  <p>&nbsp;</p>
   ...
   <div class="ColumnRight">
                    <a href="#" rel="ajax"><span style="font-weight:bold"><font color=red>•<ins> LƯU Ý : GHI NHỚ THÔNG TIN ĐỂ TIẾN HÀNH LẤY LẠI MẬT KHẨU KHI MẤT «</ins></font></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
		  </div>	
		  </div>
		  <div class="content-b">
