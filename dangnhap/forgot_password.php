...
$query = "select cAccName,cSecPassWord from Account_Info where cAccName = '$username' and cSecPassWord = '$currentPassword' ";
...
//if($currentPassword == $row["cPassWord"] && $currentPassword2 == $row["cSecPassWord"]){
   ...
   session_destroy();
   $message = "<p class = 'required'><b>Thay đổi mật khẩu thành công.</b><a href='index.php'> <b><i>Vui lòng đăng nhập lại</i></b></a></p>";
}else{
...
var username,currentPassword,currentPassword2,newPassword,confirmPassword,output = true;
...
if(!username.value) {
  username.focus();
  document.getElementById("username").innerHTML = "Vui lòng nhập tài khoản";
  output = false;
}
  ...
  document.getElementById("currentPassword").innerHTML = "Vui lòng nhập mật khẩu cấp 2";
  output = false;
}
    		...
    		<div class="col-sm-3 col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<b><span class="fontawesome-calendar" style="float:left;padding-right:10px;"></span>	Reset mật khẩu cấp 1
						</b>
...
<form name="frmChange" method="post" action="forgot_password.php?action=reset" onSubmit="return validatePassword()" >
<div style="width:300px;">
<div class="message"><?php if(isset($message)) { echo $message; } ?></div>
<table border="0" cellpadding="5" cellspacing="0" width="400" align="center" class="tblSaveForm">
<tr>
<td><b><span class="fontawesome-user">&nbsp;&nbsp;&nbsp; Tên tài khoản</span></b></td>
                        <td><input type="text" name="username" class="txtField"/><span id="username"  class="required"></td>
</tr>
<tr>
...
<tr>
<td colspan="2"><input type="submit" name="submit" class = "btn btn-primary" value="Reset mật khẩu" ></td>
