...
include_once("cauhinh.php");
	...
	if ($num_row==1)
	{
		...
		mssql_close($ketnoi);
		echo "<script language=Javascript1.1>alert(\"Bạn đã Ngừng Treo Tài Khoản thành công.Quay về trang quản lý...\");</script>";
		echo("<script language='JavaScript'>window.top.location='taikhoan.php';</script>"); 
	}
	else
	{
		echo "<script language=Javascript1.1>alert(\"Ngừng Treo Tài Khoản thất bại. Tài khoản của bạn không ở trang thái Treo.\");</script>";
