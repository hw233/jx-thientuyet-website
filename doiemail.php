...
<div class="WrapperBG">
    ...
    <div id="wrapperIn">
      <div id="header">
        ...
        <div id="download"> <a class="SetUp" href="http://volamviet.biz/taigame.htm" title="Cài đặt ngay"
          ...
          ngay</a> <a class="Register Dangky" title="Đăng ký nhanh" rel="ajax" href="dangky.php">Đăng ký nhanh</a> <a class="NapThe" rel="ajax" href="#epay&act=listcard">Nạp thẻ</a> </div>
        <a class="Logo" href="http://volamviet.biz"
                   title="Trở về trang chủ Võ Lâm Truyền Kỳ">Trở về trang chủ Võ Lâm Truyền Kỳ</a>
        <div id="boxNav">
          <ul id="nav">
            <li><a class="Nav-1" href="http://volamviet.biz" title="Trang chủ">Trang
              chủ<span>icon</span></a></li>
            <li><a class="Nav-2" href="http://volamviet.biz/tintuc" title="Tin tức">Tin tức<span>icon</span></a> </li>
            <li><a class="Nav-3" href="http://volamviet.biz/sukien" title="Sự kiện">Sự kiện<span>icon</span></a> </li>
            <li><a class="Nav-4" href="http://volamviet.biz/huongdan" title="Hướng dẫn">Hướng
          ...
          <div class="WrapperNavMenu">
            <div class="NavMenu">
              ...
              <ul>
				...
				<li><a href="#epay&act=gate" rel="ajax">•Nạp Thẻ Game</a> </li>
				<li><a href="listcard" rel="ajax">•Lịch Sử Thẻ Nạp</a></li>				
				<li><a rel="ajax" href="#acc_manager&act=kickket">•Treo Tài Khoản</a></li>
 ...
 <div class="contentHTML">
  <div class="title">
    <div class="titleLocation"> <font color=blue><b>• NHẬP THÔNG TIN XÁC THỰC ĐỂ TIẾN HÀNH ĐỔI EMAIL :</b></font></span></div>
  </div>
  ...
  <div class="boxContent">
    ...
    <div class="box_content">
      <form method="post" action="ktdoiemail.php">
        <table width="509" border="0">
          <tr>
            <td width="152"><font color=green><b>+ Email Hiện Tại :</b></font></td>
            <td width="275"><label>
              <input type="text" name="mailcu" id="mailcu" />
            </label></td>
            <td width="68">&nbsp;</td>
          </tr>
          <tr>
            <td><font color=green><b>+ Nhập Email Mới :</b></font></td>
            <td><label>
              <input type="text" name="mailmoi" id="mailmoi" />
            </label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><label>
              <input type="submit" name="Submit" value="NHẬP" class="Accept"/>
    ...
    <div class="box_image_h2"></div>
	      ...
	      <div class="ColumnRight">
                    <a href="ymsgr:sendIM?hotrovolamtruyenky&amp" rel="ajax"><span style="font-weight:bold"><font color=red>•<ins> LIÊN HỆ HỖ TRỢ NẾU KHÔNG NHỚ EMAIL TÀI KHOẢN «</ins></font></span></a>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
		  	</div>			  
		  </div>
		  <div class="content-b">
